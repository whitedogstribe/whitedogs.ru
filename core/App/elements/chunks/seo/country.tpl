    ...
    '@context' => 'https://schema.org',
        ...
        [
            ...
            'itemListElement' => [
                ...
                ['@type' => 'ListItem', 'position' => 2, 'name' => $modx->resource->pagetitle, 'item' => $site_url ~ 'countries/' ~ $modx->resource->alias],
            ],
        ],
    ],
]}
